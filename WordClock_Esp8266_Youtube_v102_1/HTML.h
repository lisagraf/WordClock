...
<body class="background">
    ...
    <div class="info">
        Die Daten werden unverschlüsselt an die WordClock übertragen.
    </div>
...
<body class="background">
    ...
    <div class="header">
        <h2>404 Not Found</h2>
        <p>Die WordClock ist verwirrt und kann deine Anfrage leider nicht beantworten.</p>
    </div>
...
<body class="background">
    ...
    <div class="header">
        ...
        <p>Du musst die WordClock nur noch neu starten.</p>
    </div>
